...
public class OAuthService {
    ...
    public String getValidAccessToken(String tenantId) {
        TenantMpCredential cred = credentialRepo.findByTenantId(tenantId)
            .orElseThrow(() -> new com.api.payments.exception.TenantNotConnectedException(tenantId));

        if (!cred.getIsActive()) {
            throw new com.api.payments.exception.TenantNotConnectedException(tenantId);
        }
